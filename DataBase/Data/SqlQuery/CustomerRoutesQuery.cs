...
namespace DataBase.Data.SqlQuery
{
    public class CustomerRoutesQuery
    {
        ...
        public static string GetFullProcedureWithoutWhere()
        {
            string sql = $@"
                SELECT 
                   {nameof(CustomerRoutes)}.{nameof(CustomerRoutes.Id)},
                   {nameof(CustomerRoutes)}.{nameof(CustomerRoutes.RoutesId)},
                   {nameof(CustomerRoutes)}.{nameof(CustomerRoutes.Name)},
                   {nameof(CustomerRoutes)}.{nameof(CustomerRoutes.Description)},
                   {nameof(CustomerRoutes)}.{nameof(CustomerRoutes.PhoneNumber)},
                   {nameof(CustomerRoutes)}.{nameof(CustomerRoutes.CreatedTicks)},
                   {nameof(CustomerRoutes)}.{nameof(CustomerRoutes.UpdatedTicks)},
                   {nameof(CustomerRoutes)}.{nameof(CustomerRoutes.Longitude)},
                   {nameof(CustomerRoutes)}.{nameof(CustomerRoutes.Latitude)},
                   {nameof(CustomerRoutes)}.{nameof(CustomerRoutes.IsDelete)},
                   {nameof(CustomerRoutes)}.{nameof(CustomerRoutes.UserCreatedId)},
                   {nameof(CustomerRoutes)}.{nameof(CustomerRoutes.UserUpdatedId)},
                    json_object(
